...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Mme Kamgain Filomette, directrice pédagogique, a adressé un message d\'accueil aux nouvelles familles et rappelé les trois piliers du GSIPG : rigueur académique, bilinguisme Fifty-Fifty et apprentissage par l\'expérience. Plus de quarante nouveaux élèves ont rejoint nos sections francophone, anglophone et bilingue.',
      'Les projets de l\'année ont été présentés : renforcement du numérique en primaire, nouvelles activités périscolaires, concours de lecture inter-classes et journées portes ouvertes trimestrielles. Le calendrier complet est disponible auprès de la vie scolaire.',
  ...
  },
  {
    ...
    title: 'Atelier créativité en maternelle',
    excerpt:
      'Initiation ludique à la créativité dès la grande section. Les plus petits expérimentent, construisent et imaginent pour développer logique et curiosité.',
    date: '2024-10-30',
    image: '/images/gallery/apprentissage/IMG-20240518-WA0002-600x300.jpg',
    imageAlt: 'Enfants participant à un atelier créativité en maternelle',
    category: 'Maternelle',
    author: 'Équipe maternelle GSIPG',
    body: [
      'À la maternelle du GSIPG, les élèves de grande section participent à des ateliers de créativité adaptés à leur âge.',
      'L\'atelier propose des défis simples : construire, assembler, imaginer et résoudre de petits problèmes concrets. Les enfants travaillent en binômes, développant ainsi la coopération, la patience et le raisonnement logique — des compétences essentielles dès le plus jeune âge.',
      'Les enseignants de maternelle accompagnent les enfants dans ces découvertes avec enthousiasme. L\'objectif est d\'éveiller la curiosité, l\'esprit d\'initiative et la confiance en soi de chaque élève.',
  ...
  },
  {
    ...
    title: 'Sortie scolaire éducative',
    excerpt:
      'Les élèves de CE1 ont participé à une sortie scolaire riche en découvertes et en apprentissages expérientiels.',
    date: '2024-11-05',
    image: '/images/gallery/activites-post-et-peri-scolaires/IMG-20240518-WA0010-600x300.jpg',
    imageAlt: 'Élèves lors d\'une sortie scolaire éducative',
    category: 'Primaire',
    author: 'Équipe CE1 GSIPG',
    body: [
      'Les élèves de CE1 ont consacré une journée entière à une sortie scolaire éducative dans le cadre de leur projet « Observer et expérimenter ». Accompagnés de leurs enseignants, ils ont découvert et exploré leur environnement.',
      'Ateliers d\'observation sur les plantes, découverte des insectes, expériences pratiques : chaque activité était liée aux objectifs pédagogiques du trimestre. Les enfants ont pris des notes, dessiné leurs observations et présenté leurs découvertes en classe le lendemain.',
      '« Apprendre en dehors de la classe change tout », confie un enseignant de CE1. « Les enfants sont plus attentifs, plus créatifs. Ces sorties sont un prolongement naturel de nos cours. »',
  ...
  },
  {
    ...
    body: [
      ...
      'Mme Kamgain Filomette a salué « le travail acharné, la persévérance et l\'esprit d\'excellence » des élèves récompensés. Elle a également encouragé tous les autres à poursuivre leurs efforts : « Chaque progrès compte, chaque effort mérite d\'être célébré. »',
